...
pos = int(input("Ingrese la posicion hasta la que desea ver la serie de Fibonacci: "))
...
def potencia(base, exponente):
    if exponente == 0:     
        ...
        return base * potencia(base, exponente - 1)     #formula n^m = n * n^(m-1)
...
print(f"{b} elevado a la {e} es igual a: {resultado}")
...
# solamente ceros (0) y unos (1), en base 2. Para convertir un número decimal a 
...
def decimal_a_binario(n):
    if n == 0:
        ...
        return decimal_a_binario(n // 2) + str(n % 2)  # # Division por 2 


num = int(input("Ingrese un número entero positivo: "))

if num == 0:      # si ingresamos 0
    print("El número en binario es: 0")
else:
    print(f"El número en binario es: {decimal_a_binario(num)}")
...
print(suma_digitos(9))     # probar
print(suma_digitos(1010))   # probar 
...
print(contar_bloques(2))  # probar
print(contar_bloques(10))  # probar
...
print(contar_digito(5554555, 4))      # probar
print(contar_digito(12345776, 7))    # probar
